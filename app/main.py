...
bg_primary = "#0f172a" if dark else "#f8fafc"
bg_card = "#1e293b" if dark else "#ffffff"
text_primary = "#f1f5f9" if dark else "#0f172a"
text_secondary = "#94a3b8" if dark else "#64748b"
border = "rgba(148, 163, 184, 0.15)" if dark else "rgba(148, 163, 184, 0.25)"
shadow = "rgba(0, 0, 0, 0.3)" if dark else "rgba(0, 0, 0, 0.08)"
